...
当前 `style/dashed` 分支会作为 FlatPaper 的虚线描边版本保留。主线主题后续已经放弃虚线边框，因此该分支视为独立样式分叉，不再合并后续功能更新；如需持续更新的主题，请使用 `main` 分支。
...
- **主题色与深色模式**：六种主题色、cookie 持久化主题色、`localStorage` 持久化深色模式，并在绘制前恢复状态。
